...
<div className="container">
  ...
  <div className="collapse navbar-collapse" id="navbarsExample04">
    <ul className="navbar-nav ml-auto">
      ...
      <NavLink className="supreme-emperor12" to={'/'}>Home</NavLink>
      </li>
      <li className="nav-item">
        {!userID && <NavLink className="supreme-emperor12" to={'/register'}>Register</NavLink>}
      </li>
      <li className="nav-item">
        {!userID &&  <NavLink className="supreme-emperor12" to={'/login'}>Login</NavLink>}
      </li>
